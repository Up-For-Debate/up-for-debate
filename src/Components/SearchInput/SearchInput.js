...
const SearchInput = props => {
	...
	const filterArr = () => {
		let filteredArr = cities.filter(
			ele =>
				ele.city.toLowerCase().includes(searchValue.toLowerCase()) ||
				ele.state.toLowerCase().includes(searchValue.toLowerCase())
		);
...
export default withRouter(
	connect(mapStateToProps, { getCityState })(SearchInput)
);
